	...
	else
	{
		...
		switch (MyAuxProcType)
		{
			...
			case ViManagerProcess:
				lbeentry.st_backendType = B_VI_MANAGER;
				break;
#endif	/* VERSION_INDEX */
			default:
...
pgstat_get_wait_activity(WaitEventActivity w)
{
	...
	switch (w)
	{
		...
		case WAIT_EVENT_WAL_WRITER_MAIN:
			...
			break;
#ifdef VERSION_INDEX
		case WAIT_EVENT_VERSION_INDEX_MANAGER_MAIN:
			event_name = "ViManagerMain";
			break;
#endif	/* VERSION_INDEX */
...
pgstat_get_wait_io(WaitEventIO w)
{
	...
	switch (w)
	{
		...
		case WAIT_EVENT_WAL_WRITE:
			...
			break;
#ifdef SMARTSSD
		case WAIT_EVENT_VERSION_INDEX_WRITE:
			event_name = "VersionIndexFileWrite";
			break;
		case WAIT_EVENT_VERSION_INDEX_SYNC:
			event_name = "VersionIndexFileSync";
			break;
		case WAIT_EVENT_VERSION_INDEX_TRUNCATE:
			event_name = "VersionIndexFileTruncate";
			break;
		/* set paramter for stat related with wait event of dirty buffer sync */
		case WAIT_EVENT_SEGMENT_DIRTY_BUFFER_SYNC:
			event_name = "SegmentDirtyBufferSync";
			break;
#endif
#ifdef VERSION_INDEX
#endif	/* VERSION_INDEX */
...
#ifdef VERSION_INDEX
		case B_VI_MANAGER:
			backendDesc = "version index manager";
			break;
#endif	/* VERSION_INDEX */
		case B_WAL_RECEIVER:

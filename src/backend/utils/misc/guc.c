...
#ifdef SMARTSSD
	{
		{"smartssd_kernel_file", PGC_POSTMASTER, FILE_LOCATIONS,
			gettext_noop("Sets the FPGA kernel file for in-ssd scan and hash join."),
			NULL,
			GUC_SUPERUSER_ONLY
		},
		&smartssd_kernel_file,
		NULL,
		NULL, NULL, NULL
	},
#endif	

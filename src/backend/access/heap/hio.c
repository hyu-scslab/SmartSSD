...
#endif
{
	...
	{
		/* Build the version index structure and write it to ViPage. */
		ViCtidData vi_ctid;
		BlockNumber blkno = BufferGetBlockNumber(buffer);

		ViExtractAndBuildViCtid(blkno, pageHeader,
								offnum, &vi_ctid);

		/* Put the built ViCtidData into a version index */
		ViPutViCtid(relation, blkno, pageHeader, offnum, &vi_ctid);
	}
#endif	/* VERSION_INDEX */

...
#if defined(SMARTSSD)
typedef void* Block;
extern TupleTableSlot *ExecStoreDeviceHeapTuple(HeapTuple tuple, 
		TupleTableSlot *slot, Buffer buffer, Block buffer_dev);
...
#if defined(SMARTSSD)
extern TupleTableSlot *ExecStoreDeviceHeapTuple(HeapTuple tuple, TupleTableSlot *slot,
	Buffer buffer, void *buffer_dev);
#endif

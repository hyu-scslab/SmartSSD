...
#ifdef VERSION_INDEX
	WAIT_EVENT_VERSION_INDEX_MANAGER_MAIN,
#endif	/* VERSION_INDEX */
...
typedef enum
{
	...
	WAIT_EVENT_VERSION_INDEX_SYNC,
	WAIT_EVENT_VERSION_INDEX_TRUNCATE,
	WAIT_EVENT_SEGMENT_DIRTY_BUFFER_SYNC /* set parameter for stat */

...
#ifdef VERSION_INDEX
#define BufferGetBufferFromPage(page) \
( \
	((char*)(page) - BufferBlocks) / (Size)BLCKSZ + 1 \
)
#endif
...
#if defined(SMARTSSD)
extern void ReadBufferFromDevice(void* ndpo, Relation reln, BlockNumber blockNum, 
...
#if defined(SMARTSSD_DBUF)
extern void FlushRelationBuffersForNDP(Relation rel);
extern void FlushSegmentBuffersForNDP(FlushDirtyBufIDList dbuf_list, 
                                      SMgrRelation reln);
#endif
...
extern bool BufferIsPinned2(int buf);
extern void NDPReleaseDirtyBufID(DirtyBufIDList dirty_bufid_list, Oid relid, 
								 uint32 segno);
extern void ReservePrivateRefCountEntry2(void);
#endif

...
#if defined(SMARTSSD)
#define SEGSZ_DEV (4UL << 20)
/* BlockNumber nitems | ItemLength ilen */
#define HDRSZ_DEV (sizeof(BlockNumber) + sizeof(ItemLength))
#define BlockGetItem(block, itemId, itemLen) \
( \
	(Item)(((char *)(block)) + (HDRSZ_DEV + (itemId - 1) * itemLen)) \
)
#endif
...
#if defined(SMARTSSD)
extern bool BlockIsVerified(char *buf, size_t sz, BlockNumber *pnum, ItemLength *plen);
#endif
...
#ifdef VERSION_INDEX
extern void PageRepairFragmentation(Page page, bool is_ndp);
#else

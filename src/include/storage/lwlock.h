...
#ifdef VERSION_INDEX
#ifdef NUM_VI_PAGE
#define NUM_VI_BUFFER_PARTITIONS 128
#else
/* Default number of version index buffer partitions */
#define NUM_VI_BUFFER_PARTITIONS (1024)
#endif	/* NUM_VI_PAGE */
#endif	/* VERSION_INDEX */
...
/* TODO: Have to modify for version index*/
#ifdef SMARTSSD_DBUF

#ifndef MAX_NUM_RELATION
#define MAX_NUM_RELATION 128
#define MAX_NUM_SEGMENT 128
#endif // #ifndef MAX_NUM_RELATION

/* The number of dirty buffer id set hash partition */
#define NUM_BUFIDSET_PARTITION 128

/* The number of heap id partition */
#define NUM_DBUF_HEAPID_HASH 1

/* The number of version entry hash table partition */
#define NUM_DBUF_CHAIN_ALLOC 4

/* The number of version stack*/
#define NUM_DBUF_FSTACK 1

#define NUM_DBUF_LIST (MAX_NUM_RELATION * MAX_NUM_SEGMENT)
...
#define DBUF_HEAPID_HASH_LWLOCK_OFFSET \
	(BUFFER_MAPPING_LWLOCK_OFFSET + NUM_BUFFER_PARTITIONS)

#define DBUF_CHAIN_ALLOC_LWLOCK_OFFSET \
	(DBUF_HEAPID_HASH_LWLOCK_OFFSET + NUM_DBUF_HEAPID_HASH)

#define DBUF_FSTACK_LWLOCK_OFFSET \
	(DBUF_CHAIN_ALLOC_LWLOCK_OFFSET + NUM_DBUF_CHAIN_ALLOC)

#define DBUF_LIST_LWLOCK_OFFSET \
	(DBUF_FSTACK_LWLOCK_OFFSET + NUM_DBUF_FSTACK)

#define VI_MAPPING_LWLOCK_OFFSET	\
	(DBUF_LIST_LWLOCK_OFFSET + NUM_DBUF_LIST)
#define LOCK_MANAGER_LWLOCK_OFFSET	\
	(VI_MAPPING_LWLOCK_OFFSET + NUM_VI_BUFFER_PARTITIONS)
...
#ifdef VERSION_INDEX
	LWTRANCHE_VI_MAPPING,
	LWTRANCHE_VI_BUFFER_IO,
	LWTRANCHE_VI_BUFFER_CONTENT,
#endif	/* VERSION_INDEX */
#ifdef SMARTSSD_DBUF
	LWTRANCHE_DBUF_HEAPID,
	LWTRANCHE_DBUF_CHAIN_ALLOC,
	LWTRANCHE_DBUF_FSTACK,
	LWTRANCHE_DBUF_CHAIN,
#endif	/* SMARTSSD_DBUF */

...
IS_CH_AND_TPCC=${IS_CH_AND_TPCC:-true}
IS_TPCC=${IS_TPCC:-true}
IS_CH=${IS_CH:-true}
IS_CITUS=${IS_CITUS:-false}
HAMMERDB_VERSION=${HAMMERDB_VERSION:-4.4}
TARGET_DB=${TARGET_DB:-my}
...
export DBPORT=${DBPORT:-23456}
export DBUSER=${DBUSER:-root}
export DBDATABASE=${DBDATABASE:-chbench}
export DBPASSWORD=${DBPASSWORD:-daktopia}
export DBSOCKET=${DBSOCKET:-/opt/s3d/ktlee20/myrocks-smartssd/inst/mysql.sock}
